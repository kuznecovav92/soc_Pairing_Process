...
{
  0x85, 0xad, 0xef, 0x3e, 0x14, 0x3c, 0x04, 0x9e, 0x91, 0x48, 0x6f, 0xa7, 0x26, 0xb3, 0x66, 0xd5, 
  0xb0, 0xb2, 0x4c, 0x10, 0x58, 0x3e, 0xb6, 0x81, 0xfc, 0x4b, 0x92, 0x73, 0x63, 0xe3, 0x24, 0x88, 
  0x6a, 0x8c, 0xc5, 0x9d, 0x5d, 0xbc, 0x2b, 0xa2, 0x9e, 0x4f, 0xfd, 0xd3, 0xb3, 0x53, 0xbe, 0xb6, 
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_20) = {
  .len = 16,
  .data = { 0xfa, 0x20, 0x34, 0x10, 0x79, 0xf5, 0xda, 0x93, 0x2b, 0x47, 0x47, 0x53, 0xf4, 0x2f, 0x28, 0x0b, }
};
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_19) = {
  .properties = 0x02,
  .max_len = 8,
  .data = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x00, 0x00, },
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x17, .uuid = 0x8000, .permissions = 0x803, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_22 },
  { .handle = 0x18, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x0a, .char_uuid = 0x8001 } },
  { .handle = 0x19, .uuid = 0x8001, .permissions = 0x913, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_24 },
  { .handle = 0x1a, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x0a, .char_uuid = 0x8002 } },
  { .handle = 0x1b, .uuid = 0x8002, .permissions = 0xa23, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_26 },
  { .handle = 0x1c, .uuid = 0x0000, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x00, .constdata = &gattdb_attribute_field_27 },
  { .handle = 0x1d, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x08, .char_uuid = 0x8003 } },
  { .handle = 0x1e, .uuid = 0x8003, .permissions = 0x802, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
};
